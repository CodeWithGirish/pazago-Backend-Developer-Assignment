...
export async function extractTextFromPDF(
  ...
  if (
    !pdfBuffer ||
    (pdfBuffer instanceof Uint8Array && pdfBuffer.length === 0) ||
    (pdfBuffer instanceof ArrayBuffer && pdfBuffer.byteLength === 0)
  ) {
  ...
  return new Promise((resolve, reject) => {
    ...
    // Ensure pdfBuffer is a Buffer or Uint8Array for parseBuffer
